...
class LipsumGenerator
{
    private const BASE_URL = "http://www.lipsum.com/feed/json";
     ...
     * @return string
     */
    public static function getParagraphs(int $amount = 5, bool $start = true): string
    {
     ...
     *
     * @param int $amount Number of words to be generated. Minimum value is 5.
     * @param bool $start Should the first paragraph start with "Lorem ipsum dolor sit amet..."
     *
     * @return string
     */
    public static function getWords(int $amount = 5, bool $start = true): string
    {
        return nl2br(static::sendRequest('words', $amount, $start === true));
    }
     ...
     * @return string
     */
    public static function getBytes(int $amount = 27, bool $start = true): string
    {
        return nl2br(static::sendRequest('bytes', $amount, $start === true));
    }
     ...
     * @return array
     */
    public static function getLists(int $amount = 5, bool $start = true): array
    {
        $return = static::sendRequest('lists', $amount, $start === true);
        $return = explode("\n", $return);
     ...
     * @return string
     */
    private static function sendRequest(string $type, int $amount, bool $start): string
    {
